    ...
    <div class="container px-0">
      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <router-link to="/authentication">
              <a class="btn btn-sm bg-gradient-primary btn-round mb-0 me-1" @click="toLogin" v-if="!isLoggedIn" href="/authentication">{{ $t('navigationBar.login') }}</a>
            </router-link>
            <a class="btn btn-sm bg-gradient-primary btn-round mb-0 me-1" @click="logout" v-if="isLoggedIn">{{ $t('navigationBar.logout') }}</a>
          </li>
        </ul>
      </div>
    </div>
