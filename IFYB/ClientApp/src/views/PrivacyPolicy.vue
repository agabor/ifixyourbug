          ...
          <div class="card mb-5">
            ...
            <div class="card-body p-5">
              ...
              <ul>
                ...
                <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Code Sharp Kft., 7625 Pécs, Vilmos utca 23 that is responsible for your information under this Privacy Policy.</li>
                <li>Country: where I Fix Your Bug or the owners/founders of I Fix Your Bug are based, in this case is Hungary</li>
                <li>Customer: refers to the company, organization or person that signs up to use the I Fix Your Bug Service to manage the relationships with your consumers or service users.</li>
                ...
                <li>Personnel: refers to those individuals who are employed by I Fix Your Bug or are under contract to perform a service on behalf of one of the parties.</li>
              ...
              <h3 class="mt-5 mb-3" id="information-we-collect">What Information Do We Collect?</h3>
              ...
              <h3 class="mt-5 mb-3">How Do We Use The Information We Collect?</h3>
              ...
              <h3 class="mt-5 mb-3">When does I Fix Your Bug use end user information from third parties?</h3>
              <p>I Fix Your Bug will collect End User Data necessary to provide the I Fix Your Bug services to our customers.</p>
              ...
              <h3 class="mt-5 mb-3">When does I Fix Your Bug use customer information from third parties?</h3>
              <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a I Fix Your Bug customer, we receive information from a third party that provides automated fraud detection services to I Fix Your Bug. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>

              <h3 class="mt-5 mb-3" >Do we share the information we collect with third parties?</h3>
              ...
              <h3 class="mt-5 mb-3">Where and when is information collected from customers and end users?</h3>
              <p>I Fix Your Bug will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>

              <h3 class="mt-5 mb-3">How Do We Use Your Email Address?</h3>
              ...
              <p>We keep your information only so long as we need it to provide I Fix Your Bug to you and fulfill the purposes described in this policy. This is also the case for anyone that we share your information with and who carries out services on our behalf. When we no longer need to use your information and there is no need for us to keep it to comply with our legal or regulatory obligations, we’ll either remove it from our systems or depersonalize it so that we can't identify you.</p>

              <h3 class="mt-5 mb-3" >How Do We Protect Your Information?</h3>
              <p>We implement a variety of security measures to maintain the safety of your personal information when you place an order or enter, submit, or access your personal information. We offer the use of a secure server. All supplied sensitive/credit information is transmitted via Secure Socket Layer (SSL) technology and then encrypted into our Payment gateway providers database only to be accessible by those authorized with special access rights to such systems, and are required to keep the information confidential. After a transaction, your private information (credit cards, social security numbers, financials, etc.) is never kept on file. We cannot, however, ensure or warrant the absolute security of any information you transmit to I Fix Your Bug or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or managerial safeguards.</p>

              <h3 class="mt-5 mb-3" >Could my information be transferred to other countries?</h3>
              <p>I Fix Your Bug is incorporated in Hungary. Information collected via our website, through direct interactions with you, or from use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border transfer and hosting of such information.</p>

              <h3 class="mt-5 mb-3" >Is the information collected through the I Fix Your Bug Service secure?</h3>
              ...
              <h3 class="mt-5 mb-3" >Can I update or correct my information?</h3>
              <p>The rights you have to request updates or corrections to the information I Fix Your Bug collects depend on your relationship with I Fix Your Bug. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
              ...
              <h3 class="mt-5 mb-3" id="personnel">Personnel</h3>
              <p>If you are a I Fix Your Bug worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
              ...
              <h3 class="mt-5 mb-3" id="sale-of-business">Sale of Business</h3>
              <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of I Fix Your Bug or any of its Corporate Affiliates (as defined herein), or that portion of I Fix Your Bug or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

              <h3 class="mt-5 mb-3" id="affiliates">Affiliates</h3>
              <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with I Fix Your Bug, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>

              <h3 class="mt-5 mb-3" >Governing Law</h3>
              ...
              <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by I Fix Your Bug. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
              ...
              <h3 class="mt-5 mb-3">Remarketing Services</h3>
              ...
              <h3 class="mt-5 mb-3">Kids' Privacy</h3>
              ...
              <h3 class="mt-5 mb-3">Changes To Our Privacy Policy</h3>
              ...
              <h3 class="mt-5 mb-3">Tracking Technologies</h3>
              <ul>
                <li>Cookies<br><br>
              ...
              <h3 class="mt-5 mb-3">Information about General Data Protection Regulation (GDPR)</h3>
              ...
              <h3 class="mt-5 mb-3">What is GDPR?</h3>
              ...
              <h3 class="mt-5 mb-3">What is personal data?</h3>
              ...
              <h3 class="mt-5 mb-3" >California Residents</h3>
              ...
              <h3 class="mt-5 mb-3" >California Online Privacy Protection Act (CalOPPA)</h3>
