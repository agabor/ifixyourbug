      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="card">
          <div class="card-header bg-gradient-primary p-5 position-relative">
            ...
            <p class="text-white opacity-8 mb-4">Last modified: Feb 01 2021</p>
          </div>
      ...
      <div class="row justify-content-center text-center">
        <div class="col-md-4 ms-auto">
          <div class="p-3">
            ...
            <h5 class="mt-3">Detailed Documentation</h5>
        ...
        <div class="col-md-4 me-auto">
          <div class="p-3">
            ...
            <p>The time is now for it to be okay to be great. People in this world shun people for being great. I'm not
              trying to do the best.</p>
          </div>
        </div>
      </div>
    </div>
